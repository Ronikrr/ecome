...
const FeedbackMessage = ({ type, message, onClear }) => {
    ...
    return (
        <div
            className={`fixed top-[100px] right-0 px-10 py-6 rounded shadow-lg capitalize transition-opacity duration-500 ${showMessage ? "opacity-100 animate-fadeIn" : "opacity-0 animate-fadeOut"
